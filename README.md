...
sibling repositories are atlas-optical (the glass, private until its
historic sources have answered) and atlas-darkroom (the instrument that
brings the parts together, private). The family is listed at the end.
...
- [atlas-engine](https://github.com/loganw234/atlas-engine) - the plate
  ...
  deterministic GLSL from it. Public, MIT.
- [PrettyCloud](https://github.com/loganw234/PrettyCloud) - the browser
  atlas at [prettycloud.io](https://prettycloud.io), and the editorial
  half of every plate. Public, MIT.
- [cft-fp256](https://github.com/loganw234/cft-fp256) - a deterministic
  ...
  Public, Apache-2.0.
- atlas-optical - the glass: the traced lens registry, the real glass
  behind it and the exact ray tracer that referees every derived
  number. Private until its historic sources have answered; MIT text.
- atlas-darkroom - the instrument that applies this package and the
  glass at exposure time: renderer, develop chemistry, the print chain,
  the commons at [platonography.com](https://platonography.com). Private.
